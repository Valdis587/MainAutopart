...
class WC_Widget_Recently_Viewed_theme extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = __( 'Просмотренные товары AutoParts', 'woocommerce' );
        $this->settings           = array(
            'title'  => array(
                'type'  => 'text',
    ...
    public function widget( $args, $instance ) {
        ...
        if ( $r->have_posts() ) {
            ...
            $this->widget_start( $args, $instance );
                ?>
            <div class="sidebar__carusel">
            <ul class="sidebar__carusel-product products owl-carousel owl-theme">
               <?php
            $template_args = array(
