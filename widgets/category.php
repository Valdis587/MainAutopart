...
class Caregory_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Категории AutoParts', 'smarkets' ), // Name
    ...
    public function widget( $args, $instance )
    {
       ...
       <nav class="sidebar__menu-category">
                     <ul class="sidebar__menu-category-list">
                    <?php
                    ...
                    if($terms) {
                        foreach($terms as $term) {
                            ...
                            if($children_terms) { ?>
                                <li class="menu-item-has-children"><a href="javascript:void(0);"><?php echo $term->name;?><i class="icon-angle-down"></i></a>
                                    <ul class="sub-menu">
