...
class LastNews_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Последние новости AutoParts', 'smarkets' ), // Name
    ...
    public function widget( $args, $instance )
    {
        ...
        if ( $r->have_posts() ) {
            ?>
 <div class="sidebar__last-news-boxs">
                    <?php
                    while ( $r->have_posts() ) {
                        global $product;
                        $r->the_post(); ?>
                        <div class="sidebar__last-news">
                     <div class="sidebar__last-news-img">
                         <?php
                     ...
                     <div class="sidebar__last-news-box">
                     <a href="<?php the_permalink(); ?>"><h3 class="sidebar__last-news-title"><?php the_title(''); ?></h3></a>
                     <a class="sidebar__last-news-button " href="<?php the_permalink(); ?>">Подробнее...</a>
                     </div>
                  </div>
                   <?php } ?>
 </div>
