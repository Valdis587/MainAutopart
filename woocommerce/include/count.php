...
add_action( 'wp_ajax_action_count', 'marketshop_count_callback' );
add_action( 'wp_ajax_nopriv_action_count', 'marketshop_count_callback' );
function marketshop_count_callback() {
