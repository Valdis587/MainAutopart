...
register_nav_menus(
    array(
        'menu-cat' => esc_html__( 'Меню категорий', 'autoparts' ),
    )
);

function AutoParts_menu_category() {
    wp_nav_menu([
        'theme_location'  => 'menu-cat',
        'menu'            => 'category',
        'container'       => false,
        'menu_class'      => 'header__menu-category-list',
        'walker'          => new AutoParts_Walker_Nav_Menu_category()
    ]);
}

class AutoParts_Walker_Nav_Menu_category extends Walker_Nav_Menu {
